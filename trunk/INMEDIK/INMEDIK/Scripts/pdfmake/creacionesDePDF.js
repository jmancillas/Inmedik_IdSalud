...
function PrintTicketOrder(OrderObj) {
    ...
    //content.push({ columns: [{ width: WithColumns, text: "Centro Médico One", style: 'normalTextCenter' }] });
    ...
    content.push({ columns: [{ width: WithColumns, text: lineasTicket, style: 'normalTextCenter' }] });
    content.push({ columns: [{ width: WithColumns, columns: [{ text: "DONACIÓN", style: 'normalText' }, { text: Ut_numberWithCommas(OrderObj.Donation), style: 'normalTextRight' }] }] });
    content.push({ columns: [{ width: WithColumns, text: lineasTicket, style: 'normalTextCenter' }] });
    ...
    content.push({
        columns: [{
            width: WithColumns, columns: [
                     ...
                     { text: "COMISIÓN", style: 'normalTextCenter' },
