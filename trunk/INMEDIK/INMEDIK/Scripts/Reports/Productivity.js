...
INMEDIKApp.controller('ProductivityController', function ($scope, $compile, $sce, $http, DTOptionsBuilder, DTColumnBuilder) {
                ...
                .withOption("ajax", {
                    ...
                    data: function (d) {
                        ...
                        d.filter = {
                            ...
                            discountTypeId_number: dt.Filters.discountTypeId_number
                        };
                    }
                })
                .withDataProp("data")
    ...
    var init = function (urlMedics, urlClinics, urlConcept, urlDiscounts) {
        $http({
            method: 'POST',
            url: urlMedics,
            headers: {
    ...
    dt.StartController = function (urlMedics, urlClinics, urlConcept, urlDiscounts) {
        if (!dt.Ready) {
            init(urlMedics, urlClinics, urlConcept, urlDiscounts);
        }
    };
});