INMEDIKApp.controller('DonationsController', function ($scope, $compile, $sce, $http, DTOptionsBuilder, DTColumnBuilder) {
    var dt = this;
    dt.Ready = false;
    dt.LoadUrl = "";
    dt.dtInstance = {};
    ...
    dt.InitTable = function (url) {
        ...
        dt.dtColumns = [
                    ...
                    DTColumnBuilder.newColumn("employeeName").withTitle("Usuario"),
                    ...
                    DTColumnBuilder.newColumn("donation").withTitle("Cantidad").renderWith(currencyFormat).withClass("sum")
        ];
    ...
    dt.StartController = function (urlClinics) {
        if (!dt.Ready) {
            init(urlClinics);
        }
    };
