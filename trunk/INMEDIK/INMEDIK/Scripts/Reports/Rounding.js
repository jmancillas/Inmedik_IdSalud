INMEDIKApp.controller('RoundingController', function ($scope, $compile, $sce, $http, DTOptionsBuilder, DTColumnBuilder) {
    var dt = this;
    dt.Ready = false;
    dt.LoadUrl = "";
    dt.dtInstance = {};
    ...
    dt.InitTable = function (url, employeelabel) {
        ...
        dt.dtColumns = [
                    ...
                    DTColumnBuilder.newColumn("total").withTitle("Total Ticket").renderWith(currencyFormat).withClass("sum"),
                    DTColumnBuilder.newColumn("rounding").withTitle("Redondeo").renderWith(currencyFormat).withClass("sum"),
        ];
